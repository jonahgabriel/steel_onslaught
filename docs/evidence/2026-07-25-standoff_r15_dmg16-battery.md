...
- Rung 1 (comparison baseline, scored): `docs/evidence/2026-07-25-rangecap_r15_dmg16-battery.md` (SO-RANGECAP, 21/30 = 0.7000, PR #197, merged `65a679a`), independently re-verified against its own ledger at `/Users/jonah/Code/omni_home/omni_worktrees/SO-RANGECAP/steel_onslaught/.onex_state/steel_onslaught/rangecap_r15_dmg16/events.sqlite3` for the §3c/§7 cross-checks in this document.
